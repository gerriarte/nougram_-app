...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["cell_version_id"], ["team_cell_versions.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("quote_item_id", name="uq_quote_item_cell_assignments_quote_item"),
    )
    op.create_index(
        op.f("ix_quote_item_cell_assignments_id"),
        "quote_item_cell_assignments",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_quote_item_cell_assignments_quote_item_id"),
        "quote_item_cell_assignments",
        ["quote_item_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_quote_item_cell_assignments_cell_id"),
        "quote_item_cell_assignments",
        ["cell_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_quote_item_cell_assignments_cell_version_id"),
        "quote_item_cell_assignments",
        ["cell_version_id"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_quote_item_cell_assignments_cell_version_id"),
        table_name="quote_item_cell_assignments",
    )
    op.drop_index(
        op.f("ix_quote_item_cell_assignments_cell_id"), table_name="quote_item_cell_assignments"
    )
    op.drop_index(
        op.f("ix_quote_item_cell_assignments_quote_item_id"),
        table_name="quote_item_cell_assignments",
    ...
    op.drop_index(
        op.f("ix_quote_item_cell_assignments_id"), table_name="quote_item_cell_assignments"
    )
