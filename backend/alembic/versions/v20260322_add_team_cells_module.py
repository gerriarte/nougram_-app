...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_team_groups_organization_id"), "team_groups", ["organization_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "organization_id", "group_id", "name", name="uq_team_cells_org_group_name"
        ),
    )
    ...
    op.create_index(
        op.f("ix_team_cells_organization_id"), "team_cells", ["organization_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=16), nullable=False, server_default=sa.text("'published'")
        ),
    ...
    op.create_index(
        op.f("ix_team_cell_versions_cell_id"), "team_cell_versions", ["cell_id"], unique=False
    )
    op.create_index(
        op.f("ix_team_cell_versions_organization_id"),
        "team_cell_versions",
        ["organization_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "cell_version_id", "team_member_id", name="uq_team_cell_member_versions_unique_member"
        ),
    )
    op.create_index(
        op.f("ix_team_cell_member_versions_id"), "team_cell_member_versions", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_team_cell_member_versions_cell_version_id"),
        "team_cell_member_versions",
        ["cell_version_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_team_cell_member_versions_organization_id"),
        "team_cell_member_versions",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_team_cell_member_versions_team_member_id"),
        "team_cell_member_versions",
        ["team_member_id"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_team_cell_member_versions_team_member_id"), table_name="team_cell_member_versions"
    )
    op.drop_index(
        op.f("ix_team_cell_member_versions_organization_id"), table_name="team_cell_member_versions"
    )
    op.drop_index(
        op.f("ix_team_cell_member_versions_cell_version_id"), table_name="team_cell_member_versions"
    )
