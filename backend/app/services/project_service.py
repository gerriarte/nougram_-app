...
class ProjectService:
    ...
    async def _build_quote_response(self, quote: Quote) -> QuoteResponseWithItems:
        ...
        return QuoteResponseWithItems(
            ...
            is_active=bool(getattr(final_quote, "is_active", 1)),
            deletion_requested_at=getattr(final_quote, "deletion_requested_at", None),
            deletion_requested_by_id=getattr(final_quote, "deletion_requested_by_id", None),
            deletion_request_reason=getattr(final_quote, "deletion_request_reason", None),
