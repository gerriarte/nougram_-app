...
"""
from sqlalchemy import Column, Integer, String, Numeric, Date, Boolean, ForeignKey, DateTime, Index, func
...
class EquipmentAmortization(Base):
    ...
    salvage_value = Column(Numeric(15, 2), default=0, nullable=False)  # ⚠️ CRÍTICO: Valor de salvamento
